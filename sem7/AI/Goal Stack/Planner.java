...
/*
aaditya@aaditya-inspiron-5559:~/Desktop/BE Practical/AI/Goal Stack$ javac State.java 
aaditya@aaditya-inspiron-5559:~/Desktop/BE Practical/AI/Goal Stack$ javac Planner.java 
Note: Planner.java uses unchecked or unsafe operations.
Note: Recompile with -Xlint:unchecked for details.
aaditya@aaditya-inspiron-5559:~/Desktop/BE Practical/AI/Goal Stack$ java Planner 
Enter number of blocks :4
Enter initial state : (on b a)^(ontable c)^(ontable d)^(ontable a)^(AE)
Enter goal state : (on c a)^(on b d)^(ontable a)^(ontable d)^(AE)
[(unstack b a), (release b), (stack c a), (stack b d)]
aaditya@aaditya-inspiron-5559:~/Desktop/BE Practical/AI/Goal Stack$ 
*/
